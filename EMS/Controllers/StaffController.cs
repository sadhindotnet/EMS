...
namespace EMS.Controllers
{
    ...
    public class StaffController : ControllerBase
    {
        ...
        {
            return _unitOfWork.StaffRepo.GetAll();
        }
        ...
        {
            var user = await _unitOfWork.StaffRepo.GetById(id);
            if (user == null)
        ...
        // POST: api/Users
        [HttpPost]
        public IActionResult Post(Staff entity)
        {
            _unitOfWork.StaffRepo.Add(entity);
        ...
        // PUT: api/Staff/5
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, Staff entity)
        {
            var existing = await _unitOfWork.StaffRepo.GetById(id);
            if (existing == null)
                return NotFound($"User with ID = {id} not found");
            ...
            _unitOfWork.StaffRepo.Update(existing);
            message = _unitOfWork.Save();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.StaffRepo.Delete(existing);
            message = _unitOfWork.Save();
