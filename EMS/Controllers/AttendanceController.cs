...
namespace EMS.Controllers
{
    ...
    public class AttendanceController : ControllerBase
    {
        ...
        // GET: api/Users
        [HttpGet]
        public Task<IEnumerable<Attendance>> Get()
        {
            return _unitOfWork.AttendanceRepo.GetAll();
        }
        ...
        {
            var user = await _unitOfWork.AttendanceRepo.GetById(id);
            if (user == null)
        ...
        // POST: api/Users
        [HttpPost]
        public IActionResult Post(Attendance entity)
        {
            _unitOfWork.AttendanceRepo.Add(entity);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, Attendance entity)
        {
            var existing = await _unitOfWork.AttendanceRepo.GetById(id);
            if (existing == null)
                return NotFound($"User with ID = {id} not found");
            ...
            _unitOfWork.AttendanceRepo.Update(existing);
            message = _unitOfWork.Save();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.AttendanceRepo.Delete(existing);
            message = _unitOfWork.Save();
