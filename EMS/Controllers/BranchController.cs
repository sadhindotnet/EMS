...
namespace EMS.Controllers
{
    ...
    public class BranchController : ControllerBase
    {
        ...
        {
            var user = await _unitOfWork.BranchRepo.GetById(id);
            if (user == null)
        ...
        // POST: api/Users
        [HttpPost]
        public IActionResult Post(Branch entity)
        {
            _unitOfWork.BranchRepo.Add(entity);
        ...
        {
            var existing = await _unitOfWork.BranchRepo.GetById(id);
            if (existing == null)
                return NotFound($"User with ID = {id} not found");
            ...
            existing.HeadOffice = entity.HeadOffice;
            ...
            _unitOfWork.BranchRepo.Update(existing);
            message = _unitOfWork.Save();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.BranchRepo.Delete(existing);
            message = _unitOfWork.Save();
