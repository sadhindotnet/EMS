...
namespace EMS.Controllers
{
    ...
    public class NoticeController : ControllerBase
    {
        ...
        // GET: api/Users
        [HttpGet]
        public Task<IEnumerable<Notice>> Get()
        {
            return _unitOfWork.NoticeRepo.GetAll();
        }
        ...
        {
            var user = await _unitOfWork.NoticeRepo.GetById(id);
            if (user == null)
        ...
        // POST: api/Users
        [HttpPost]
        public IActionResult Post(Notice entity)
        {
            _unitOfWork.NoticeRepo.Add(entity);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, Notice entity)
        {
            var existing = await _unitOfWork.NoticeRepo.GetById(id);
            if (existing == null)
                return NotFound($"User with ID = {id} not found");
            ...
            _unitOfWork.NoticeRepo.Update(existing);
            message = _unitOfWork.Save();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.NoticeRepo.Delete(existing);
            message = _unitOfWork.Save();
