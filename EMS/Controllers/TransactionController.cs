...
namespace EMS.Controllers
{
    ...
    public class TransactionController : ControllerBase
    {
        ...
        {
            var user = await _unitOfWork.TransactionRepo.GetById(id);
            if (user == null)
        ...
        // POST: api/Users
        [HttpPost]
        public IActionResult Post(Transaction entity)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, Transaction entity)
        {
            var existing = await _unitOfWork.TransactionRepo.GetById(id);
            if (existing == null)
                return NotFound($"User with ID = {id} not found");
            ...
            _unitOfWork.TransactionRepo.Update(existing);
            message = _unitOfWork.Save();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.TransactionRepo.Delete(existing);
            message = _unitOfWork.Save();
