...
namespace EMS.Controllers
{
    ...
    public class SectionController : ControllerBase
    {
        ...
        {
            return _unitOfWork.SectionRepo.GetAll();
        }
        ...
        {
            var user = await _unitOfWork.SectionRepo.GetById(id);
            if (user == null)
        ...
        // POST: api/Users
        [HttpPost]
        public IActionResult Post(Section entity)
        {
            _unitOfWork.SectionRepo.Add(entity);
        ...
        // PUT: api/Section/5
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, Section entity)
        {
            var existing = await _unitOfWork.SectionRepo.GetById(id);
            if (existing == null)
                return NotFound($"User with ID = {id} not found");
            ...
            _unitOfWork.SectionRepo.Update(existing);
            message = _unitOfWork.Save();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.SectionRepo.Delete(existing);
            message = _unitOfWork.Save();
