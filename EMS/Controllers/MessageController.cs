...
namespace EMS.Controllers
{
    ...
    public class MessageController : ControllerBase
    {
        ...
        {
            return _unitOfWork.MessageRepo.GetAll();
        }
        ...
        {
            var user = await _unitOfWork.MessageRepo.GetById(id);
            if (user == null)
        ...
        // POST: api/Users
        [HttpPost]
        public IActionResult Post(Message entity)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, Message entity)
        {
            var existing = await _unitOfWork.MessageRepo.GetById(id);
            if (existing == null)
                return NotFound($"User with ID = {id} not found");

            // Update necessary fields
            existing.SenderUserId = entity.SenderUserId;
            existing.ReceiverUserId = entity.ReceiverUserId;
            existing.Subject = entity.Subject;
            existing.Body = entity.Body;
            existing.SentAt = entity.SentAt;
            ...
            _unitOfWork.MessageRepo.Update(existing);
            message = _unitOfWork.Save();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.MessageRepo.Delete(existing);
            message = _unitOfWork.Save();
