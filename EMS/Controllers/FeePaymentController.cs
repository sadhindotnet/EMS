...
namespace EMS.Controllers
{
    ...
    public class FeePaymentController : ControllerBase
    {
        ...
        public FeePaymentController(IUnitOfWork unitOfWork)
        {
        ...
        // GET: api/Users
        [HttpGet]
        public Task<IEnumerable<FeePayment>> Get()
        {
            return _unitOfWork.FeePaymentRepo.GetAll();
        }
        ...
        {
            var user = await _unitOfWork.FeePaymentRepo.GetById(id);
            if (user == null)
        ...
        // POST: api/Users
        [HttpPost]
        public IActionResult Post(FeePayment entity)
        {
            _unitOfWork.FeePaymentRepo.Add(entity);
        ...
        // PUT: api/FeePayment/5
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, FeePayment entity)
        {
            var existing = await _unitOfWork.FeePaymentRepo.GetById(id);
            if (existing == null)
                return NotFound($"User with ID = {id} not found");
            ...
            _unitOfWork.FeePaymentRepo.Update(existing);
            message = _unitOfWork.Save();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.FeePaymentRepo.Delete(existing);
            message = _unitOfWork.Save();
